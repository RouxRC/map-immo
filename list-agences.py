...
while cururl:
    ...
    for annonce in annonces:
        ...
        adress = adress.replace("de gaulles", "de gaulle")
        adress = adress.replace("rivoli place de la concorde", "rivoli")
        adress = adress.replace(" ongle 6 rue nobel", "")
        adress = adress.replace("antoine cour du bel air ", "antoine")
